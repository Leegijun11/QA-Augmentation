# -*- coding: utf-8 -*-
"""01_baseline_T5.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1K_JeMlL1NN5lAUNRZR0mRz51gZT6kwoT
...
dataset2 = load_dataset('squad_kor_v1', split='validation')

train = pd.DataFrame(dataset)
test  = pd.DataFrame(dataset2)

train = train.sample(n=3000, random_state=42)
test  = test.sample(n=500,   random_state=42)

train.to_csv('../data/train_sampled.csv', index=False)
test.to_csv('../data/test_sampled.csv',   index=False)

print(f"train: {train.shape}, test: {test.shape}")

"""# 2. 토크나이저 모델 & GPU device"""
