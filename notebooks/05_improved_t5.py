# -*- coding: utf-8 -*-
"""05_improved_t5.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1PCesa5pwcjoKM9Dt9Nm713fa9Qk8jxTU
...
train = pd.read_csv('/content/sample_data/train_augmented.csv')
test  = pd.read_csv('/content/sample_data/test_sampled.csv')
...
def run_evaluate_loop(model, test_loader, device):
    ...
    with torch.no_grad():
        ...
        for idx, batch in enumerate(progress_bar):
            ...
            # wrong_cases 분석 결과 정답 대부분 25자 이내 → max_length 32로 축소
            generated      = model.generate(input_ids=input_ids, max_length=32)
